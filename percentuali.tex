...
\end{exercise}
\begin{exercise}[no solution]
	Un commerciante mette in vendita una coperta praticando il \SI{10}{\percent} di sconto. Dopo un mese  la offre con uno scontandola del \SI{30}{\percent}. Se lo sconto complessivo è stato di \EUR{300}. Quale era il prezzo iniziale?
\end{exercise}
\begin{exercise}
